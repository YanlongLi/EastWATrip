...
\title{A Three-Day Exploration of Eastern Washington}
...
\newcommand{\LakeChelanStatePark}{\href{https://maps.app.goo.gl/SG8UQnPoWd1ubnXq7}{Lake Chelan State Park}}
...
\tikzstyle{locationTextDayOne} = [font=\sffamily\bfseries\normalsize,align=left,fill=dayOneColor,text=white,line width=0.5mm,inner sep=6pt,fill opacity=0.5,text opacity=1,scale=1,draw=white,rounded corners]
\tikzstyle{locationTextDayTwo} = [font=\sffamily\bfseries\normalsize,align=left,fill=dayTwoColor,text=white,line width=0.5mm,inner sep=6pt,fill opacity=0.5,text opacity=1,scale=1,draw=white,rounded corners]
\tikzstyle{locationTextDayThree} = [font=\sffamily\bfseries\normalsize,align=left,fill=dayThreeColor,text=white,line width=0.5mm,inner sep=6pt,fill opacity=0.5,text opacity=1,scale=1,draw=white,rounded corners]
...
\begin{landscape}
  ...
  \begin{figure}[p]
    ...
    % Include the JPEG image
      \node[anchor=south west,inner sep=0,opacity=1] (image) at (0,0) {\includegraphics[width=1.3\textwidth]{background.jpg}}; % Change "example-image.jpg" to the filename of your JPEG image
      ...
      % Pullman
      \draw[myline] (\DayTwoTimelineX,0.5) -- (\DayTwoTimelineX,\DayOneTimelineY) -- (14.6,2.5) -- (14.6,4.2);
      ...
      % Spokane
      \draw[myline] (\DayTwoXOne,\DayTwoPFourY) -- (\DayTwoTimelineX,\DayTwoPFourY) -- (14.05,10) -- (14.05,8.15);
      ...
      \draw[linkingLineDayThree] (\DayThreePTwoX,\DayThreeYOne) -- (\DayThreePTwoX,\DayThreeTimelineY) -- (\DayThreePTwoX,\DayThreeTimelineY-3.0) -- (8.7,8.0);
      \node[locationTextDayThree] at (\DayThreePTwoX,\DayThreeTimelineY-3.0) {\DryFallsVisitorCenter};

      % Lake Chelan State Park
      \draw[linkingLineDayThree] (\DayThreePThreeX,\DayThreeYOne) -- (\DayThreePThreeX,\DayThreeTimelineY) -- (\DayThreePThreeX,\DayThreeTimelineY-2) -- (6.5,9.0);
      ...
      \node[timelineText] at (\DayThreePOneX,\DayThreeYOne) {10:00};
      \node[timelineText] at (\DayThreePTwoX,\DayThreeYOne) {12:00-13:00};
      \node[timelineText] at (\DayThreePFourX,\DayThreeYOne) {17:00};
...
% \begin{abstract}
% 
% This paper presents a three-day travel itinerary for exploring the natural wonders of Eastern Washington.
...
\end{itemize}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
    % Include the JPEG image
      \node[anchor=south west,inner sep=0,opacity=1,scale=0.5] (image) at (0,0) {\includegraphics[width=1.3\textwidth]{_images/Wild Horse Renewable Energy Center.jpg}}; % Change "example-image.jpg" to the filename of your JPEG image
    \end{tikzpicture}
...
\end{itemize}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
    % Include the JPEG image
      \node[anchor=south west,inner sep=0,opacity=1,scale=0.5] (image) at (0,0) {\includegraphics[width=1.3\textwidth]{_images/Wild Horse Monument.jpg}}; % Change "example-image.jpg" to the filename of your JPEG image
    \end{tikzpicture}
...
\end{itemize}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
    % Include the JPEG image
      \node[anchor=south west,inner sep=0,opacity=1,scale=0.5] (image) at (0,0) {\includegraphics[width=1.3\textwidth]{_images/Scenic Overlook of the Columbia River.jpg}}; % Change "example-image.jpg" to the filename of your JPEG image
    \end{tikzpicture}
...
\end{itemize}
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
    % Include the JPEG image
      \node[anchor=south west,inner sep=0,opacity=1,scale=0.5] (image) at (0,0) {\includegraphics[width=1.3\textwidth]{_images/Palouse Falls State Park.jpg}}; % Change "example-image.jpg" to the filename of your JPEG image
    \end{tikzpicture}
...
\end{itemize}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
    % Include the JPEG image
      \node[anchor=south west,inner sep=0,opacity=1,scale=0.5] (image) at (0,0) {\includegraphics[width=1.3\textwidth]{_images/Kamiak Butte Country Park.jpg}}; % Change "example-image.jpg" to the filename of your JPEG image
    \end{tikzpicture}
...
\end{itemize}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
    % Include the JPEG image
      \node[anchor=south west,inner sep=0,opacity=1,scale=0.5] (image) at (0,0) {\includegraphics[width=1.3\textwidth]{_images/Steptoe Butte State Park.jpg}}; % Change "example-image.jpg" to the filename of your JPEG image
    \end{tikzpicture}
...
\subsection{\DryFallsVisitorCenter}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
    % Include the JPEG image
      \node[anchor=south west,inner sep=0,opacity=1,scale=0.5] (image) at (0,0) {\includegraphics[width=1.3\textwidth]{_images/Dry Falls Visitor Center.jpg}}; % Change "example-image.jpg" to the filename of your JPEG image
    \end{tikzpicture}
